...
exit_icon= tk.PhotoImage(file='icons2/exit1.png')
...
size_box['values']= tuple(range(8,80,1))
size_box.current(4)
...
align_right_btn.grid(row=0,column=12,padx=5)


align_center_icon = tk.PhotoImage(file='icons2/align_center.png')
align_center_btn=ttk.Button(tool_bar,image=align_center_icon)
align_center_btn.grid(row=0,column=14,padx=5)
...
view.add_checkbutton(label='Tool Bar',onvalue=True,offvalue=0,image=tool_icon,variable = show_toolbar,compound=tk.LEFT,command=hide_toolbar)
view.add_checkbutton(label='status Bar',onvalue=1, offvalue=False, image=status_icon,variable = show_statusbar,compound=tk.LEFT,command=hide_statusbar)
